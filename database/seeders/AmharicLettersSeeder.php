...
class AmharicLettersSeeder extends Seeder
{
    ...
    {
        $letters = [
            ['letter' => 'ሀ', 'group_id' => 1, 'position' => 1, 'transliterations' => json_encode(['hä', 'ha', 'haa', 'haaa', 'hah', 'huh', 'haaaha']), 'created_at' => now(), 'updated_at' => now()],
            ...
            ['letter' => 'ሄ', 'group_id' => 1, 'position' => 5, 'transliterations' => json_encode(['he', 'hey','heh', 'hee']), 'created_at' => now(), 'updated_at' => now()],
            ['letter' => 'ህ', 'group_id' => 1, 'position' => 6, 'transliterations' => json_encode(['heeeeh', 'eh', 'heh']), 'created_at' => now(), 'updated_at' => now()],
            ['letter' => 'ሆ', 'group_id' => 1, 'position' => 7, 'transliterations' => json_encode(['ho', 'oh', 'hoo']), 'created_at' => now(), 'updated_at' => now()],
        ];
