                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                ...
                                <input type="hidden" name="transliterations" id="transliterations-hidden" value="">
                            </div>
                            <p class="mt-1 text-sm text-gray-500">Type a pronunciation and press Enter, or click "Generate from word" to auto-fill.</p>
                        ...
                        <div>
                            ...
                            <select name="engine" id="engine"
                                ...
                                <option value="v1" @selected(old('engine') === 'v1')>Google v1</option>
                                <option value="v2" @selected(old('engine') === 'v2')>Google v2 (Chirp)</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 mb-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Category</label>
                                                            <select name="categories[]" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" style="border: 1px solid #d1d5db !important;">
